"""
scripts/verify_2018_interim.py
------------------------------
Verifies the complete 2018 interim dataset against all scientific and operational requirements.
...
def verify_2018_interim():
    interim_dir = Path("data/interim/2018")
    expected_dates = get_expected_dates_for_year(2018)

    print("=" * 80)
    print(f"VERIFYING 2018 INTERIM DATASET ({len(expected_dates)} Expected Days)")
    print("=" * 80)
    ...
    # 3. Verify physical unnormalized units on sample day (Mid-year: 2018-07-02)
    ...
    moments_path = Path("data/norm_stats/moments_2018.json")
    ...
    print(f"  moments_2018.json exists and verified with 7 physical variables, all count > 3,000,000 points.")

    print("\n" + "=" * 80)
    print("ALL 2018 INTERIM DATASET VERIFICATION CHECKS PASSED (100%)")
    print("=" * 80)
