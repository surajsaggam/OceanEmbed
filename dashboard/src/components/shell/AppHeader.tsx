  ...
  return (
    <>
      ...
      >
        ...
        <nav aria-label="Platform Context" className="flex items-center gap-3 text-sm shrink-0">
          <button
            type="button"
            onClick={() => setAboutOpen(true)}
            className="text-sm font-medium text-[#475569] hover:text-[#0d253d] transition-colors cursor-pointer tracking-[-0.01em] py-1 px-1 rounded-sm focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-[#533afd]/20"
          >
            About
          </button>
          <span className="text-[#94a3b8] select-none text-xs" aria-hidden="true">
            ·
          </span>
          <button
            type="button"
